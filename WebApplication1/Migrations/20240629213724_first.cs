        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DriverLicense = table.Column<byte[]>(type: "longblob", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Surname = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DriverLicense = table.Column<byte[]>(type: "longblob", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeparturePoint = table.Column<int>(type: "int", maxLength: 255, nullable: false),
                    ArrivalPoint = table.Column<int>(type: "int", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trips_Cities_ArrivalPoint",
                        column: x => x.ArrivalPoint,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trips_Cities_DeparturePoint",
                        column: x => x.DeparturePoint,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_ArrivalPoint",
                table: "Trips",
                column: "ArrivalPoint");

            migrationBuilder.CreateIndex(
                name: "IX_Trips_DeparturePoint",
                table: "Trips",
                column: "DeparturePoint");
